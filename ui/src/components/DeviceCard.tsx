  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        ...
        {device.mac_conflict && (
          <div
            className="flex items-center gap-1.5 px-2 py-1 rounded bg-orange-950/60 border border-orange-800/50"
            title={`MAC changed from ${device.mac_conflict} — possible ARP spoofing`}
          >
            <svg viewBox="0 0 16 16" fill="currentColor" className="w-3 h-3 text-orange-400 shrink-0">
              <path d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
            </svg>
            <span className="text-[10px] text-orange-300 font-medium">
              MAC changed · was {device.mac_conflict}
            </span>
          </div>
        )}
      </div>
